...
self.addEventListener("fetch", event => {
  ...
  if (url.pathname.endsWith("/menu.json") || url.pathname.endsWith("menu.json") || url.pathname.endsWith("/brand.json") || url.pathname.endsWith("brand.json")) {
    event.respondWith(networkFirstMenuData(request));
    return;
  }
